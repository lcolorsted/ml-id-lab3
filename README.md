...
**QA** - this stage uses the CloudFormation template file **sagemaker_prediction_endpoint.yaml** found in the **CloudFormation** directory. CloudFormation is used to launch a Sagemaker QA Endpoint based on the ML model created in the Build_and_Train stage. 
